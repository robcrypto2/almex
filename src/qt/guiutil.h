...
/** Utility functions used by the ALMEX Qt UI.
 */
namespace GUIUtil
{
...
// Render ALMEX addresses in monospace font
...
// Parse "almex:" URI into recipient object, return true on successful parsing
