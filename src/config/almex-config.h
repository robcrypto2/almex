/* src/config/almex-config.h.  Generated from almex-config.h.in by configure.  */
/* src/config/almex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ALMEX_CONFIG_H

#define ALMEX_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://almex.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Almex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Almex Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "almex"
